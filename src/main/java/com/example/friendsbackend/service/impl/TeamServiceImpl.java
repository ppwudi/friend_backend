...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    private static final String SALT = "ppwudi_team";
    private static final String BY_TEAM_IDS = String.format("ppwudi:team:getTeamListByTeamIds:%s", "byTeamIds");
    private static final String TEAMS_KEY = String.format("ppwudi:team:getTeams:%s", "getTeams");
    @Resource
    ...
    public Boolean joinTeam(JoinTeamRequest joinTeamRequest, User loginUser) {
        ...
        RLock lock = redissonClient.getLock("ppwudi:join_team");
